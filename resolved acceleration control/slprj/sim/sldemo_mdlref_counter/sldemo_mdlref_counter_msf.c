...
slmrSetModelRefAutoSolverStatusFlags ( S , 75 ) ; ssSetRTWGeneratedSFcn ( S ,
...
SS_NOT_REUSABLE_AND_GLOBAL ) ; slmrModelRefSetHasDescExpFcnMdl ( S , false )
...
#define MDL_START
static void mdlStart ( SimStruct * S ) { j0v54a0zxtl * dw = ( j0v54a0zxtl * )
ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ;
ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } b51pkukdad ( S ,
...
j0v54a0zxtl * dw = ( j0v54a0zxtl * ) ssGetDWork ( S , 0 ) ; const real_T *
i_f3v3hwhrmw = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T *
i_occ4v3edtd = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
i_cv3o5eiw3e = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T *
o_o_B_2_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid !=
...
; return ; } static void mdlTerminate ( SimStruct * S ) { return ; }
...
dwFieldNames ) ; { mxArray * mdlrefDW = mr_sldemo_mdlref_counter_GetDWork (
ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_sldemo_mdlref_counter_GetSimStateDisallowedBlocks ( ) ;
